...
/***/ function(module, exports, __webpack_require__) {
	...
	var grid_1 = __webpack_require__(9);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Grid = (function (_super) {
	    ...
	    Grid.prototype.componentDidMount = function () {
	        var _this = this;
	        this.props.adapter.find().then(function (entities) {
	    ...
	    Grid.prototype.render = function () {
	        ...
	        return (React.createElement("div", {className: "moravia-grid"}, React.createElement(header_1.Header, {columns: this.props.columns, selected: allSelected, onSelectAll: function () { return _this.handleSelectAll(); }}), React.createElement("div", {className: "moravia-grid-body"}, this.state.entities.map(function (entity, index) {
